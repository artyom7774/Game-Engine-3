from ..updating import v3110to3120, v3120to3121, v3121to3122, v3122to3123, v3123to3124, v3124to3125, v3125to3126, v3126to3130, v3130to3131, v3131to3132, v3132to3133, v3133to3140, v3140to3150, v3150to3151, v3151to3152, v3152to3153, v3153to3160, v3160to3161, v3161to3162
...
versionsUpdatingFunctions = {
    ...
    "3.15.3 -> 3.16.0": lambda name: v3153to3160.updating(name),
    "3.16.0 -> 3.16.1": lambda name: v3160to3161.updating(name),
    "3.16.1 -> 3.16.2": lambda name: v3161to3162.updating(name)
}
