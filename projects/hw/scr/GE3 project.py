...
VARIABLES = {
    "globals": {},
    "locals": {'projects/hw/project/functions/1.func': {}},
    "objects": {'projects/hw/project/scenes/%scene%1': {'1-0.objc': {}}}
}

SETTINGS = {'name': 'GE3 project', 'icon': '', 'debug': False, 'fps': 60, 'tps': 20, 'start_scene': 'projects/hw/project/scenes/%scene%1', 'width': 500, 'height': 500}
PROGRAMS = {'projects/hw/project/functions/1.func': {'variables': {}, 'objects': {'789460414': {'display': {'discription': 'starts at the start of the game', 'name': 'On start game', 'text': {'__none__': '', '__path__': 'path'}}, 'height': 3, 'id': 789460414, 'inputs': {}, 'name': 'onStartGame', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}}, 'type': 'event', 'width': 6, 'x': 8, 'y': 4}, '293843335': {'display': {'discription': '...', 'name': 'Write text', 'text': {'__none__': '', '__path__': 'path', '__text__': 'text'}}, 'height': 3, 'id': 293843335, 'inputs': {'path': {'code': 'path', 'name': '__path__', 'standard': None, 'type': 'path', 'value': {'id': 789460414, 'name': 'path'}}, 'text': {'code': 'text', 'name': '__text__', 'standard': 'ggfgf', 'type': 'text', 'value': None}}, 'name': 'writeText', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}}, 'type': 'text', 'width': 6, 'x': 19, 'y': 4}, '229709963': {'display': {'discription': '...', 'name': 'Display text', 'text': {'__none__': '', '__path__': 'path', '__text__': 'text', '__x__': 'X', '__y__': 'Y'}}, 'height': 5, 'id': 229709963, 'inputs': {'path': {'code': 'path', 'name': '__path__', 'standard': None, 'type': 'path', 'value': {'id': 498160156, 'name': 'path'}}, 'x': {'code': 'x', 'name': '__x__', 'standard': 0, 'type': 'number', 'value': None}, 'y': {'code': 'y', 'name': '__y__', 'standard': 0, 'type': 'number', 'value': None}, 'text': {'code': 'text', 'name': '__text__', 'standard': 'erferrere', 'type': 'text', 'value': None}}, 'name': 'displayText', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}}, 'type': 'text', 'width': 10, 'x': 19, 'y': 10}, '498160156': {'display': {'discription': 'start every N frames', 'name': 'Every N frame', 'text': {'__n__': 'N', '__none__': '', '__path__': 'path'}}, 'height': 3, 'id': 498160156, 'inputs': {'path': {'code': 'path', 'name': '__path__', 'standard': None, 'type': 'path', 'value': None}, 'N': {'code': 'N', 'name': '__n__', 'standard': 1, 'type': 'number', 'value': None, 'visible': False}}, 'name': 'everyFrame', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}}, 'type': 'event', 'width': 6, 'x': 8, 'y': 12}}}}
OBJECTS = {'1.obj': {'type': 'StaticObject', 'variables': {'pos': [0, 0], 'hitbox': [0, 0, 32, 32], 'sprite': ['', 0, 0, -1, -1], 'group': 'object', 'layer': 0}}}
SCENES = {'projects/hw/project/scenes/%scene%1': {'objects': {'1-0.objc': {'type': 'StaticObject', 'variables': {'pos': [2, -30], 'hitbox': [0, 0, 32, 32], 'sprite': ['', 0, 0, -1, -1], 'group': 'object', 'layer': 0}}}, 'focus': '1-0.objc'}}
