...
VARIABLES = {
    "globals": {'speed': {'name': 'speed', 'type': 'number', 'value': 3.5}, 'start': {'name': 'start', 'type': 'number', 'value': 864}, 'last': {'name': 'last', 'type': 'number', 'value': 0}, 'new': {'name': 'new', 'type': 'number', 'value': 1}, 'score': {'name': 'score', 'type': 'number', 'value': 0}},
