...
SCENES = {'projects/test/project/scenes/%scene%1': {'objects': {'1-1.objc': {'type': 'StaticObject', 'variables': {'pos': [175.0, 9.0], 'hitbox': [0, 0, 32, 32], 'sprite': ['assets/player.png', 0, 0, -1, -1], 'group': 'player', 'layer': 0, 'animation': {'groups': {}}, 'invisible': False}}, '1-4.objc': {'type': 'DynamicObject', 'variables': {'pos': [156.0, -70.0], 'hitbox': [0, 0, 32, 32], 'sprite': ['assets/player.png', 0, 0, -1, -1], 'group': 'player', 'layer': 0, 'animation': {'groups': {}}, 'invisible': False, 'speed': 5, 'gravity': 300, 'jumpPower': 10, 'slidingStep': 1000000.0}}}, 'focus': '1-4.objc'}}
