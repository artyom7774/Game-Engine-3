...
PROGRAMS = {'projects/python/project/functions/1.func': {'variables': {}, 'objects': {'770631245': {'display': {'discription': 'Run python code', 'name': 'Python', 'text': {'__answer__': 'answer', '__dict__': 'dict', '__list__': 'list', '__none__': '', '__path__': 'path', '__text__': 'text'}}, 'height': 5, 'id': 770631245, 'inputs': {'path': {'code': 'path', 'name': '__path__', 'standard': None, 'type': 'path', 'value': {'id': 526881689, 'name': 'path'}}, 'text': {'code': 'text', 'name': '__text__', 'standard': 'def run(program, args, kwargs):\n\treturn [1, 2, 3]\n', 'type': 'text', 'value': None}, 'list': {'code': 'list', 'name': '__list__', 'standard': [], 'type': 'list', 'value': None}, 'dict': {'code': 'dict', 'name': '__dict__', 'standard': {}, 'type': 'dict', 'value': None}}, 'name': 'python', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}, 'answer': {'code': 'answer', 'name': '__answer__', 'type': 'list'}}, 'sorting': {'inputs': ['path', 'text', 'list', 'dict'], 'outputs': ['path', 'answer']}, 'special': {'inputs': {'dict': {'invisible': True}, 'list': {'invisible': True}, 'text': {'height': 3, 'type': 'text-box'}}}, 'type': 'another', 'width': 10, 'x': 23, 'y': 7}, '526881689': {'display': {'discription': 'starts at the start of the game', 'name': 'On start game', 'text': {'__none__': '', '__path__': 'path'}}, 'height': 3, 'id': 526881689, 'inputs': {}, 'name': 'onStartGame', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}}, 'type': 'event', 'width': 6, 'x': 15, 'y': 7}, '902224121': {'display': {'discription': 'Run python code', 'name': 'Python', 'text': {'__answer__': 'answer', '__dict__': 'dict', '__list__': 'list', '__none__': '', '__path__': 'path', '__text__': 'text'}}, 'height': 5, 'id': 902224121, 'inputs': {'path': {'code': 'path', 'name': '__path__', 'standard': None, 'type': 'path', 'value': {'id': 770631245, 'name': 'path'}}, 'text': {'code': 'text', 'name': '__text__', 'standard': 'def run(program, args, kwargs):\n\tprint(decodeHolder("%math(%global_var(var) + 1)"))\n', 'type': 'text', 'value': None}, 'list': {'code': 'list', 'name': '__list__', 'standard': [], 'type': 'list', 'value': {'id': 770631245, 'name': 'answer'}}, 'dict': {'code': 'dict', 'name': '__dict__', 'standard': {}, 'type': 'dict', 'value': None}}, 'name': 'python', 'outputs': {'path': {'code': 'path', 'name': '__path__', 'type': 'path'}, 'answer': {'code': 'answer', 'name': '__answer__', 'type': 'list'}}, 'sorting': {'inputs': ['path', 'text', 'list', 'dict'], 'outputs': ['path', 'answer']}, 'special': {'inputs': {'dict': {'invisible': True}, 'list': {'invisible': True}, 'text': {'height': 3, 'type': 'text-box'}}}, 'type': 'another', 'width': 10, 'x': 35, 'y': 7}}}}
