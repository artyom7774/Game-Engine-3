...
VARIABLES = {
    "globals": {},
    "locals": {},
    "objects": {'projects/123/project/scenes/%scene%1': {'player-0.objc': {}}}
}

SETTINGS = {'name': 'GE3 project', 'icon': '', 'debug': False, 'fps': 60, 'tps': 20, 'start_scene': 'projects/123/project/scenes/%scene%1', 'width': 500, 'height': 500}
PROGRAMS = {}
...
SCENES = {'projects/123/project/scenes/%scene%1': {'objects': {'player-0.objc': {'type': 'DynamicObject', 'variables': {'pos': [-61, -136], 'hitbox': [0, 0, 40, 43], 'sprite': ['assets/player.png', 0, 0, -1, -1], 'group': 'player', 'layer': 0, 'speed': 5, 'gravity': 300, 'jumpPower': 15, 'slidingStep': 1000000.0}}}, 'focus': 'player-0.objc'}}
